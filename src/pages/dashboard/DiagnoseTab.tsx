...
const DiagnoseTab = () => {
  ...
  return (
    <div className="space-y-8 p-6">
      <div className=" mb-12">
        <h2 className="text-3xl font-semibold text-slate-900">Creator Profile Analysis</h2>
        <p className="text-slate-500">Deep dive into your content ecosystem, audience, and performance patterns</p>
      </div>
